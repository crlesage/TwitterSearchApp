    ...
    public String getUrl ()
{
    ...
    {
        return "ClassPojo [location = "+location+", default_profile = "+default_profile+", profile_background_tile = "+profile_background_tile+", statuses_count = "+statuses_count+", lang = "+lang+", profile_link_color = "+profile_link_color+", profile_banner_url = "+profile_banner_url+", id = "+id+", following = "+following+", isProtected = "+isProtected+", favourites_count = "+favourites_count+", profile_text_color = "+profile_text_color+", description = "+description+", verified = "+verified+", contributors_enabled = "+contributors_enabled+", profile_sidebar_border_color = "+profile_sidebar_border_color+", name = "+name+", profile_background_color = "+profile_background_color+", created_at = "+created_at+", is_translation_enabled = "+is_translation_enabled+", default_profile_image = "+default_profile_image+", followers_count = "+followers_count+", has_extended_profile = "+has_extended_profile+", profile_image_url_https = "+profile_image_url_https+", geo_enabled = "+geo_enabled+", profile_background_image_url = "+profile_background_image_url+", profile_background_image_url_https = "+profile_background_image_url_https+", follow_request_sent = "+follow_request_sent+", entities = "+entities+", url = "+url+", utc_offset = "+utc_offset+", time_zone = "+time_zone+", notifications = "+notifications+", profile_use_background_image = "+profile_use_background_image+", friends_count = "+friends_count+", profile_sidebar_fill_color = "+profile_sidebar_fill_color+", screen_name = "+screen_name+", id_str = "+id_str+", profile_image_url = "+profile_image_url+", listed_count = "+listed_count+", is_translator = "+is_translator+"]";
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.default_profile);
        dest.writeString(this.profile_background_tile);
        ...
        dest.writeString(this.listed_count);
        dest.writeString(this.is_translator);
    }
    ...
    protected User(Parcel in) {
        ...
        this.default_profile = in.readString();
        this.profile_background_tile = in.readString();
        ...
        this.listed_count = in.readString();
        this.is_translator = in.readString();
    }
