...
//    {
//        return "ClassPojo [retweeted = "+retweeted+", in_reply_to_screen_name = "+in_reply_to_screen_name+", possibly_sensitive = "+possibly_sensitive+", truncated = "+truncated+", lang = "+lang+", in_reply_to_status_id_str = "+in_reply_to_status_id_str+", id = "+id+", in_reply_to_user_id_str = "+in_reply_to_user_id_str+", in_reply_to_status_id = "+in_reply_to_status_id+", created_at = "+created_at+", favorite_count = "+favorite_count+", place = "+place+", coordinates = "+coordinates+", metadata = "+metadata+", text = "+text+", contributors = "+contributors+", retweeted_status = "+retweeted_status+", geo = "+geo+", entities = "+entities+", is_quote_status = "+is_quote_status+", source = "+source+", favorited = "+favorited+", in_reply_to_user_id = "+in_reply_to_user_id+", retweet_count = "+retweet_count+", id_str = "+id_str+", user = "+user+"]";
//    }
...
//        this.retweeted_status = in.readParcelable(Retweeted_status.class.getClassLoader());
